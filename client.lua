...
Citizen.CreateThread(function()
	while true do
		if ESX.IsPlayerLoaded(PlayerId) then
			...
			ESX.TriggerServerCallback('felixLl_hud:getjoblabel', function(joblabel)
				ESX.TriggerServerCallback('felixLl_hud:getjobgradelabel', function(jobgradelabel)
					ESX.TriggerServerCallback('felixLl_hud:getjobname', function(jobname)
			...
			ESX.TriggerServerCallback('felixLl_hud:getCash', function(money)
...
RegisterNetEvent('felixLl_hud:updateStatus')
AddEventHandler('felixLl_hud:updateStatus', function(status)
	SendNUIMessage({action = "updateStatus", status = status})
end)

RegisterNetEvent('felixLl_hud:updateWeight')
AddEventHandler('felixLl_hud:updateWeight', function(weight)
